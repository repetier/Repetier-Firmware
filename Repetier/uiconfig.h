...
#define UI_SET_PRESET_HEATED_BED_TEMP 60
#define UI_SET_PRESET_EXTRUDER0_TEMP 170
#define UI_SET_PRESET_EXTRUDER1_TEMP 170
// Extreme values 
...
#define UI_MATRIX_ACTIONS {UI_ACTION_HOME_ALL, UI_ACTION_TOP_MENU,       UI_ACTION_SET_ORIGIN,      UI_ACTION_NEXT,\
                           ...
                           UI_ACTION_HOME_Y,   UI_ACTION_MENU_YPOSFAST,  UI_ACTION_PREHEAT,         UI_ACTION_PREVIOUS,\
...
// **** Quick menu
UI_MENU_ACTIONCOMMAND(ui_menu_quick_preheat,UI_TEXT_PREHEAT,UI_ACTION_PREHEAT);
...
UI_MENU_CHANGEACTION(ui_menu_cext_advancek,UI_TEXT_EXTR_ADVANCEK,UI_ACTION_ADVANCE_K);
#ifdef TEMP_PID
...
#endif
#define UI_MENU_CEXTR {UI_MENU_ADDCONDBACK UI_MENU_CONFEXTCOND &ui_menu_cext_steps,&ui_menu_cext_start_feedrate,&ui_menu_cext_max_feedrate,&ui_menu_cext_acceleration,&ui_menu_cext_watch_period,&ui_menu_cext_advancek UI_MENU_PIDCOND}
UI_MENU(ui_menu_cextr,UI_MENU_CEXTR,6+UI_MENU_BACKCNT+UI_MENU_PIDCNT+UI_MENU_CONFEXTCNT);
