...
//   commented these pin definitions out
...
// the below pin defs are for a RAMBo board and Reprapdiscount Smart LCD controller
...
void ui_init_keys() {
  ...
  UI_KEYS_INIT_BUTTON_LOW(78); // push button, connects gnd to pin
...
void ui_check_keys(int &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(76,77);  
 UI_KEYS_BUTTON_LOW(78,UI_ACTION_OK); 
 UI_KEYS_BUTTON_LOW(KILL_PIN,UI_ACTION_KILL);
