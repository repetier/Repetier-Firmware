...
//----------------------------------------------------------------------------------
// Zonestar printer extra configuration (until added to the web configurator)
//----------------------------------------------------------------------------------
// A bit optimized settings for Zonestar 3D printer with Melzi board.
...
// It is a bit faster than Repetier firmware defaults.
//  
// Do not forget to update X/Y/Z min positions for your printer (it homes with
// negative values for X/Y) and then set X/Y/Z travel so the printer does not
// kick max ends (all set from General tab of web configurator).
// It id best to flash/run the firmware with EEPROM modes 2, then 1 to
// ensure you have this firmware defaults and not stored from the old one.
//
// User config below provides support for the Zonestar ADC keypad controller.
//----------------------------------------------------------------------------------

// This setting should be moved to the web configuration option.
// Until done, it is defined here to be used by the Zonestar controller.
#define ADC_KEYPAD_PIN 1

// This option overrides currently set fake LCD that is enabled to make
// visible UI options. It also should be provided by the web configurator
