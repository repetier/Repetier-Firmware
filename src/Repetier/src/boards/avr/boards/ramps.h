...
#if MOTHERBOARD == MOTHERBOARD_RAMPS_1_4
#define KNOWN_BOARD 1
#define RAMPS_V_1_3
#elif MOTHERBOARD == MOTHERBOARD_AZTEEG_X3
#define KNOWN_BOARD 1
#define RAMPS_V_1_3
#define AZTEEG_X3
#elif MOTHERBOARD == MOTHERBOARD_AZTEEG_X3_PRO
#define KNOWN_BOARD 1
#define RAMPS_V_1_3
#define AZTEEG_X3_PRO
#elif MOTHERBOARD == ZONESTAR_ZRIB_2_1
#define KNOWN_BOARD 1
#define RAMPS_V_1_3
#define ZRIB_V2
#elif MOTHERBOARD == MOTHERBOARD_MPX3
#define RAMPS_V_1_3
#define MPX3
#endif
...
// Pin assigment defined by reprapdiscount whcih is used on nearly all ramps displays
#undef BEEPER_PIN
#define BEEPER_PIN 37
