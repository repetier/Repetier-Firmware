...
#ifndef UI_NEOPIXEL_BRIGHTNESS
#define UI_NEOPIXEL_BRIGHTNESS 127
#endif
// Uses SPI for sd card and display so both need to be hardware SPI at least for arm chips
#define DISPLAY_UC1701_12864_HW_SPI 1
#define UI_HAS_CONTRAST 1
#endif
...
// Map controller types to drivers and set meningfull defaults if not predefined
    ...
    || FEATURE_CONTROLLER == CONTROLLER_ORCABOTXXLPRO2 || FEATURE_CONTROLLER == CONTROLLER_ENDER_3_12864 || FEATURE_CONTROLLER == CONTROLLER_CR10_EXP3
...
#if ENABLED(DISPLAY_ST7920_SW) || ENABLED(DISPLAY_ST7920_HW) || ENABLED(U8GLIB_ST7565_NHD_C2832_SW_SPI) || ENABLED(U8GLIB_ST7565_NHD_C2832_HW_SPI) || ENABLED(DISPLAY_UC1701_12864_SW_SPI) || ENABLED(DISPLAY_UC1701_12864_HW_SPI)
#undef DISPLAY_DRIVER
