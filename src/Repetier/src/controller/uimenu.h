...
*/
#define UI_PAGES \
    { &ui_page1 UI_PRINTTIME_PAGES, &ui_page4 UI_EXTRUDERS_PAGES }
...
*/
#define UI_PAGES \
    { &ui_page1, &ui_page2, &ui_page3 UI_PRINTTIME_PAGES }
// How many pages do you want to have. Minimum is 1.
...
#define UI_MENU_LANGUAGES \
    { UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR }
#define UI_MENU_LANGUAGES_WIZ \
    { ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR }
...
#define UI_MENU_POSITIONS \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all, &ui_menu_home_x, &ui_menu_home_y, &ui_menu_home_z UI_SPEED_X UI_SPEED_Y UI_SPEED_Z, &ui_menu_go_epos SERVOPOS_ENTRY, &ui_menu_go_offsets }
...
#define UI_MENU_POSITIONS \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all UI_SPEED_X UI_SPEED_Y UI_SPEED_Z, &ui_menu_go_epos SERVOPOS_ENTRY, &ui_menu_go_offsets }
...
#define UI_MENU_DELTA \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all UI_SPEED_Z_NOTEST, &ui_menu_set_measured_origin, &ui_menu_measure_zprobe_height }
...
#define UI_MENU_CHF_ITEMS \
    { &ui_menu_chf_head UI_MENU_EXTSEL, &ui_menu_chf_temp, &ui_menu_chf_continue, &ui_menu_chf_close }
...
#define UI_MENU_QUICK \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY, &ui_menu_quick_speedmultiply UI_MENU_FLOWCONF_COND UI_TOOGLE_LIGHT_ENTRY UI_FANSPEED UI_FAN2SPEED UI_CHANGE_FIL_ENT UI_MENU_PREHEAT_COND, &ui_menu_quick_origin, \
...
#define UI_MENU_ADJUST \
    { UI_MENU_ADDCONDBACK &ui_menu_adjust_nocoating, &ui_menu_adjust_buildtak, &ui_menu_adjust_kapton, &ui_menu_adjust_bluetape, &ui_menu_adjust_pettape, &ui_menu_adjust_gluestick, &ui_menu_adjust_custom }
...
#define UI_MENU_GENERAL \
    { UI_MENU_ADDCONDBACK &ui_menu_general_baud, &ui_menu_general_stepper_inactive, &ui_menu_general_max_inactive UI_TOOGLE_AUTOLEVEL_ENTRY }
...
#define UI_MENU_BEDCONF \
    { UI_MENU_ADDCONDBACK &ui_menu_cext_manager, &ui_menu_cext_pgain, &ui_menu_cext_igain, &ui_menu_cext_dgain, &ui_menu_cext_dmin, &ui_menu_cext_dmax, &ui_menu_cext_pgain_dt, &ui_menu_cext_pmax }
...
#define UI_MENU_CONFIGURATION \
    { UI_MENU_ADDCONDBACK LANGMENU_ENTRY &ui_menu_general_baud, &ui_menu_general_stepper_inactive, &ui_menu_general_max_inactive, &ui_menu_conf_accel, &ui_menu_conf_feed UI_MENU_EXTCONF_COND UI_MENU_BEDCONF_COND UI_MENU_EEPROM_COND UI_MENU_DELTA_COND UI_MENU_SL_COND }
...
#define UI_MENU_PREHEAT_SUB \
    { &ui_menu_preheat_hdl UI_MENU_ADDCONDBACK_C UI_MENU_PREHEAT_BED UI_MENU_PREHEAT_EXT0 UI_MENU_PREHEAT_EXT1 UI_MENU_PREHEAT_EXT2 UI_MENU_PREHEAT_EXT3 UI_MENU_PREHEAT_EXT4 UI_MENU_PREHEAT_EXT5 }
...
#define UI_MENU_PREHEAT_COUNT 1
#else
#define UI_MENU_PREHEAT
#define UI_MENU_PREHEAT_COUNT 0
#endif
...
#define UI_MENU_SETUP \
    { UI_MENU_ADDCONDBACK& ui_debug UI_MENU_PREHEAT UI_TOOGLE_AUTOLEVEL_ENTRY UI_DISTORTION_ENTRY UI_CAL_ZHEIGHT_ENTRY UI_IGNORE106_ENTRY }
UI_MENU(ui_menu_setup, UI_MENU_SETUP, UI_MENU_BACKCNT + 1 + UI_MENU_PREHEAT_COUNT + UI_TOGGLE_AUTOLEVEL_COUNT + UI_DISTORTION_COUNT + UI_MENU_FAN_CNT + UI_CAL_ZHEIGHT_CNT)
...
#define UI_MENU_MAIN \
    { UI_MENU_ADDCONDBACK &ui_menu_control, &ui_stop, &ui_pause, &ui_continue UI_TEMP0_PRINTING UI_TEMP1_PRINTING UI_TEMP2_PRINTING UI_TEMP3_PRINTING UI_TEMP4_PRINTING UI_TEMP5_PRINTING UI_BED_TEMP_PRINTING, &ui_menu_quick_speedmultiply_printing UI_CHANGE_FIL_ENT_PRINTING UI_MENU_FLOWPRINT_COND UI_FANSPEED_PRINTING UI_FAN2SPEED_PRINTING UI_IGNORE106_ENTRY_PRINTING BABY_ENTRY_PRINTING SD_PRINTFILE_ENTRY, &ui_menu_move, UI_MENU_EXTCONT_COND UI_MENU_COATING_COND UI_MENU_SD_COND &ui_setup, &ui_menu_settings }

UI_MENU(ui_menu_main, UI_MENU_MAIN, 8 + UI_MENU_FLOWPRINT_CNT + UI_MENU_EXTCONT_CNT + UI_MENU_BACKCNT + UI_MENU_SD_CNT + SD_PRINTFILE_ENTRY_CNT + UI_MENU_COATING_CNT + UI_TEMP0_CNT + UI_TEMP1_CNT + UI_TEMP2_CNT + UI_TEMP3_CNT + UI_TEMP4_CNT + UI_TEMP5_CNT + BABY_CNT + HAVE_HEATED_BED + 2 * UI_MENU_FAN_CNT + UI_MENU_FAN2_CNT + UI_CHANGE_FIL_CNT)
