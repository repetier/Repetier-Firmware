...
STEPPER_TMC2209_SW_UART(XMotor, IOX1Step, IOX1Dir, IOX1Enable, X_SERIAL_RX_PIN, X_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#if IDEX
STEPPER_TMC2209_SW_UART(AMotor, IOA1Step, IOA1Dir, IOA1Enable, E4_SERIAL_RX_PIN, E4_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#endif
#if DUAL_Y
#if DUAL_Y_ENDSTOP
STEPPER_TMC2209_SW_UART(Y1Motor, IOY1Step, IOY1Dir, IOY1Enable, Y_SERIAL_RX_PIN, Y_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopYMin1,
                        endstopNone)
STEPPER_TMC2209_SW_UART(Y2Motor, IOY2Step, IOY2Dir, IOY2Enable, E3_SERIAL_RX_PIN, E3_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopYMin2,
                        endstopNone)
#else
STEPPER_TMC2209_SW_UART(Y1Motor, IOY1Step, IOY1Dir, IOY1Enable, Y_SERIAL_RX_PIN, Y_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
STEPPER_TMC2209_SW_UART(Y2Motor, IOY2Step, IOY2Dir, IOY2Enable, E3_SERIAL_RX_PIN, E3_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#endif
STEPPER_MIRROR2(YMotor, Y1Motor, Y2Motor, endstopNone, endstopNone)
#else
STEPPER_TMC2209_SW_UART(YMotor, IOY1Step, IOY1Dir, IOY1Enable, Y_SERIAL_RX_PIN, Y_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#endif

#ifdef STACKER_2_Z_END_STOPS

STEPPER_TMC2209_SW_UART(Z1Motor, IOZ1Step, IOZ1Dir, IOZ1Enable, Z_SERIAL_RX_PIN, Z_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopZMax1)
STEPPER_TMC2209_SW_UART(Z2Motor, IOZ2Step, IOZ2Dir, IOZ2Enable, E2_SERIAL_RX_PIN, E2_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopZMax2)
#else
STEPPER_TMC2209_SW_UART(Z1Motor, IOZ1Step, IOZ1Dir, IOZ1Enable, Z_SERIAL_RX_PIN, Z_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
...
#endif
STEPPER_MIRROR2(ZMotor, Z1Motor, Z2Motor, endstopNone, endstopNone)
STEPPER_TMC2209_SW_UART(E1Motor, IOE1Step, IOE1Dir, IOE1Enable, E0_SERIAL_RX_PIN, E0_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#if IDEX
STEPPER_TMC2209_SW_UART(E2Motor, IOE2Step, IOE2Dir, IOE2Enable, E1_SERIAL_RX_PIN, E1_SERIAL_TX_PIN, 0.10, MICROSTEPS, 900, 8, 100, 1, -128, 12500000, endstopNone,
                        endstopNone)
#endif
#else
