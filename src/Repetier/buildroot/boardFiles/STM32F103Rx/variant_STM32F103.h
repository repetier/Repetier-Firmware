...
//                  |---------|----------------|--------------------------|-----------|-----------------------|-----------|
#define PA0 0   //PIN_A0 // | 0       | A0             |                          |           |                       |           |
#define PA1 1   // PIN_A1 // | 1       | A1             |                          |           |                       |           |
#define PA2 2   // PIN_A2 // | 2       | A2             | USART2_TX                |           |                       |           |
#define PA3 3   // PIN_A3 // | 2       | A2, DAC_OUT1** | USART2_RX                |           |                       |           |
#define PA4 4   // PIN_A4 // | 4       | A4, DAC_OUT2** |                          |           | SPI1_SS               |           |
#define PA5 5   // PIN_A5 // | 5       | A5             |                          |           | SPI1_SCK              |           |
#define PA6 6   // PIN_A6 // | 6       | A6             |                          |           | SPI1_MISO             |           |
#define PA7 7   // PIN_A7 // | 7       | A7             |                          |           | SPI1_MOSI             |           |
#define PA8 8   // | 8       |                |                          |           |                       |           |
...
//                  |---------|----------------|--------------------------|-----------|-----------------------|-----------|
#define PB0 16  // PIN_A8 // | 16      | A8             |                          |           |                       |           |
#define PB1 17  // PIN_A9 // | 17      | A9             |                          |           |                       |           |
...
//                  |---------|----------------|--------------------------|-----------|-----------------------|-----------|
#define PC0 32  // PIN_A10 // | 32      | A10            |                          |           |                       |           |
#define PC1 33  // PIN_A11 // | 33      | A11            |                          |           |                       |           |
#define PC2 34  // PIN_A12 // | 34      | A12            |                          |           |                       |           |
#define PC3 35  // PIN_A13 // | 35      | A13            |                          |           |                       |           |
#define PC4 36  // PIN_A14 // | 36      | A14            |                          |           |                       |           |
#define PC5 37  //PIN_A15 // | 37      | A15            |                          |           |                       |           |
#define PC6 38  // | 38      |                |                          |           |                       |           |
#define PC7 39  // | 39      |                |                          |           |                       |           |
#define PC8 40  // | 40      |                |                          |           |                       |           |
#define PC9 41  // | 41      |                |                          |           |                       |           |
