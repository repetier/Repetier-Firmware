...
if 'offset' in board_keys:
	...
	helper.replace_define('STM32_FLASH_SIZE', maximum_flash_size)
...
if 'encrypt' in board_keys:
	...
	def encrypt(source, target, env):
		helper.encrypt_mks(source, target, env, board.get("build.encrypt"))

	helper.add_post_action(encrypt)
...
if 'rename' in board_keys:
	...
	helper.add_post_action(rename_target)
