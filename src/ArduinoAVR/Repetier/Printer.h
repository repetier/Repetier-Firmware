...
#define ENDSTOP_X2_MINMAX_ID 256
#define ENDSTOP_Y2_MINMAX_ID 512
...
#ifdef EXTENDED_ENDSTOPS
      return (lastState & (ENDSTOP_X_MAX_ID | ENDSTOP_Y_MAX_ID | ENDSTOP_Z_MAX_ID | ENDSTOP_X_MIN_ID | ENDSTOP_Y_MIN_ID | ENDSTOP_Z_MIN_ID | ENDSTOP_X2_MIN_ID | ENDSTOP_Y2_MIN_ID | ENDSTOP_Z2_MIN_ID)) != 0 ||
             lastState2 != 0;
#else
      return (lastState & (ENDSTOP_X_MAX_ID | ENDSTOP_Y_MAX_ID | ENDSTOP_Z_MAX_ID | ENDSTOP_X_MIN_ID | ENDSTOP_Y_MIN_ID | ENDSTOP_Z_MIN_ID | ENDSTOP_X2_MIN_ID | ENDSTOP_Y2_MIN_ID | ENDSTOP_Z2_MIN_ID)) != 0;
#endif
