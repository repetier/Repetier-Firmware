...
// then you have 3 seconds of increased heating to reach 1буC.
...
parameter to then tangens of the deviation from 90бу when you print a square object.
E.g. if you angle is 91бу enter tan(1) = 0.017. If error doubles you have the wrong sign.
Always hard to say since the other angle is 89бу in this case!
*/
