...
/* Define the type of axis movements needed for your printer. The typical casis a full cartesian system where x, y and z moves are handled by separate motors.
.
