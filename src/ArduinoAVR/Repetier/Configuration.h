...
#define MIN_HARDWARE_ENDSTOP_X2 1
#define ENDSTOP_X2_MIN_INVERTING 1
#define X2_MIN_PIN 2
#define ENDSTOP_PULLUP_X2_MIN 1
...
#define MIN_HARDWARE_ENDSTOP_Y2 1
#define ENDSTOP_Y2_MIN_INVERTING 1
#define Y2_MIN_PIN 15
#define ENDSTOP_PULLUP_Y2_MIN 1
