...
//*** Added IK
#ifndef MINMAX_HARDWARE_ENDSTOP_X2
#define MINMAX_HARDWARE_ENDSTOP_X2 0
#define X2_MINMAX_PIN -1
#endif

#if MINMAX_HARDWARE_ENDSTOP_X2 && X2_MINMAX_PIN > -1
#undef MULTI_XENDSTOP_HOMING 
...
#ifndef MINMAX_HARDWARE_ENDSTOP_Y2
#define MINMAX_HARDWARE_ENDSTOP_Y2 0
#define Y2_MINMAX_PIN -1
#endif

#if MINMAX_HARDWARE_ENDSTOP_Y2 && Y2_MINMAX_PIN > -1
#undef MULTI_YENDSTOP_HOMING 
