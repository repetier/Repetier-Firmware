...
#define PDM_TIMER_VECTOR TIMER2_COMPB_vect
#define PDM_OCR OCR2B
#define PDM_TCCR TCCR2B
#define PDM_TIMSK TIMSK2
#define PDM_OCIE OCIE2B
#else*/
...
#define PDM_TIMER_VECTOR TIMER0_COMPB_vect
#define PDM_OCR OCR0B
#define PDM_TCCR TCCR0A
#define PDM_TIMSK TIMSK0
#define PDM_OCIE OCIE0B
//#endif
#endif // HAL_H
