...
// ---- EEPROM related events ------

// Write content to serial (M205)
#define EVENT_EEPROM_WRITE_SETTINGS
// Get data from EEPROM
#define EVENT_EEPROM_READ_FROM_EEPROM
#define EVENT_EEPROM_INIT_UNCACHED
// Store data into eeprom
#define EVENT_EEPROM_STORE_DATA_INTO_EEPROM
