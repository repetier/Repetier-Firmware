...
#define MOTHERBOARD MOTHERBOARD_E3_MINI_V2_0
#define EEPROM_MODE EEPROM_I2C

#define RFSERIAL SerialUSB 
#define BLUETOOTH_SERIAL -1 // Set this to 2 if you're using a BTT TFT!
// Note: On the V2 version of the mini, you must connect both the TFT
// port/pins AND the the EXP1 port to the TFT. Otherwise it won't power on. 
...
// SKR E3 Mini V2 - Leave this at 2.
...
// SKR E3 Mini V2 - Set NUM_FANS to 2 and add &Fan2PWM to the fan list
// to enable control of the second fan port on the board!  
#define NUM_FANS 2
#define FAN_LIST \
    { &Fan1PWM, &Fan2PWM }
...
#define UI_PRINTER_NAME "SKR E3 Mini V2.0"
