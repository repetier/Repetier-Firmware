...
#define MOTHERBOARD MOTHERBOARD_SKR_2 // MOTHERBOARD_FELIX // 405
//#define MOTHERBOARD MOTHERBOARD_RUMBA32 // MOTHERBOARD_FELIX // 405
#define EEPROM_MODE 0
#define SAFE_HOMING 0 // enable safe homing
