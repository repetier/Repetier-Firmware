...
*/
UI_WIZARD4_T(ui_menu_zpos_notest_wiz, UI_ACTION_ZPOSITION_NOTEST, UI_TEXT_ACTION_ZPOSITION4A_ID, UI_TEXT_ACTION_ZPOSITION4B_ID, UI_TEXT_ACTION_ZPOSITION4C_ID, UI_TEXT_ACTION_ZPOSITION4D_ID)
UI_WIZARD4_T(ui_menu_zpos_fast_notest_wiz, UI_ACTION_ZPOSITION_FAST_NOTEST, UI_TEXT_ACTION_ZPOSITION_FAST4A_ID, UI_TEXT_ACTION_ZPOSITION_FAST4B_ID, UI_TEXT_ACTION_ZPOSITION_FAST4C_ID, UI_TEXT_ACTION_ZPOSITION_FAST4D_ID)
...
UI_MENU_ACTIONCOMMAND_T(ui_czds_pg1_cont, UI_CTEXT_CONTINUE_ID, UI_ACTION_CZDS_P1_CONT)
...
UI_MENU_ACTIONCOMMAND(ui_czds_pg1_menu, "Calib.Z diff.Syringe", UI_ACTION_CZDS_P1)
...
UI_MENU_ACTIONSELECTOR(ui_czds_pg2_zfast, "Z 1mm up/down", ui_menu_zpos_fast_notest_wiz)
UI_MENU_ACTIONSELECTOR(ui_czds_pg2_zslow, "Z 0,01mm up/down", ui_menu_zpos_notest_wiz)

UI_MENU_ACTIONCOMMAND_T(ui_czds_pg2_cont, UI_CTEXT_CONTINUE_ID, UI_ACTION_CZDS_P2_CONT)
#define UI_CZDS_P2_ITEMS \
    { &ui_czds_pg2_1, &ui_czds_pg2_2, &ui_czds_pg2_3, &ui_czds_pg2_zfast, &ui_czds_pg2_zslow, \
      &ui_czds_pg2_cont, &ui_czds_pg1_exit }
UI_STICKYMENU(ui_czds_p2, UI_CZDS_P2_ITEMS, 7)
UI_WIZARD4(ui_czds_p3, UI_ACTION_MESSAGE, "Calib.Z diff.Syringe", "", "New height stored.", "     >>> OK <<<")
...
#ifdef BIOPRINTER
#define UI_CALEXTR_SUBITEMS \
    { &ui_menu_back, &ui_calex_z, &ui_calex_xy, &ui_calex_xyv2, &ui_czds_pg1_menu }
...
#define UI_MENU_LANGUAGES \
    { UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_RU }
#define UI_MENU_LANGUAGES_WIZ \
    { ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_RU }
...
#define UI_MENU_OFFSETS \
    { UI_MENU_ADDCONDBACK &ui_menu_off_xpos, &ui_menu_off_ypos, &ui_menu_off_zpos }
...
#define UI_MENU_POSITIONS \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all, &ui_menu_home_x, &ui_menu_home_y, &ui_menu_home_z UI_SPEED_X UI_SPEED_Y UI_SPEED_Z SERVOPOS_ENTRY }
...
#define UI_MENU_MZP_ITEMS \
    { &ui_menu_mzp_head, &ui_menu_mzp_realz, &ui_menu_mzp_cont, &ui_menu_mzp_close }
...
#define UI_MENU_DELTA \
    { UI_MENU_ADDCONDBACK &ui_menu_home_all UI_SPEED_Z_NOTEST, &ui_menu_set_measured_origin }
...
#define UI_MENU_LEVEL \
    { UI_MENU_ADDCONDBACK &ui_menu_set_p1, &ui_menu_set_p2, &ui_menu_set_p3, &ui_menu_calculate_leveling UI_SPEED_X UI_SPEED_Y UI_SPEED_Z }
...
#define UI_MENU_EXTRUDER \
    { UI_MENU_ADDCONDBACK UI_MENU_BEDCOND UI_MENU_EXTCOND &ui_menu_go_epos, &ui_menu_ext_origin UI_DITTO_COMMANDS }
...
#define UI_MENU_FAN \
    { UI_MENU_ADDCONDBACK &ui_menu_fan_fanspeed, &ui_menu_fan_off, &ui_menu_fan_25, &ui_menu_fan_50, &ui_menu_fan_75, &ui_menu_fan_full, &ui_menu_fan_ignoreM106 }
...
#define UI_MENU_GENERAL \
    { UI_MENU_ADDCONDBACK &ui_menu_general_baud, &ui_menu_general_stepper_inactive, &ui_menu_general_max_inactive UI_TOOGLE_AUTOLEVEL_ENTRY UI_CALIB_PROBE_ENTRY }
...
#define UI_MENU_ADJUST \
    { UI_MENU_ADDCONDBACK &ui_menu_adjust_buildtak, &ui_menu_adjust_kapton, &ui_menu_adjust_custom }
...
#define UI_MENU_CH2_ITEMS \
    { &ui_menu_chf_head, &ui_menu_ch2_back, \
...
#define UI_MENU_CHF_ITEMS \
    { &ui_menu_chf_head UI_MENU_EXTSEL, &ui_menu_chf_temp, \
...
#define UI_MENU_QUICK \
    { UI_MENU_ADDCONDBACK &ui_preheatcool2 UI_CHANGE_FIL_ENT, &ui_removebed, &ui_menu_move, &ui_menu_quick_stopstepper UI_FANSPEED, &ui_menu_ext_temp0, &ui_menu_ext_temp1, &ui_menu_bed_temp, &ui_menu_autolevelbed UI_CALIB_PROBE_ENTRY, &ui_calex }
#else
...
*/
#define UI_MENU_QUICK \
    { UI_MENU_ADDCONDBACK &ui_preheatcool1 UI_CHANGE_FIL_ENT, &ui_removebed, &ui_menu_move, &ui_menu_quick_stopstepper UI_FANSPEED, &ui_menu_ext_temp0, &ui_menu_ext_temp1, &ui_menu_bed_temp, &ui_menu_autolevelbed UI_CALIB_PROBE_ENTRY, &ui_calex }
#endif
...
#define UI_MENU_ASKSTOP \
    { &ui_menu_empty, &ui_menu_askstop_head, &ui_menu_empty, &ui_menu_sd_askstop_no, &ui_menu_sd_askstop_yes }
UI_MENU(ui_menu_askstop, UI_MENU_ASKSTOP, 5)
#elif UI_ROWS == 4
#define UI_MENU_ASKSTOP \
    { &ui_menu_askstop_head, &ui_menu_empty, &ui_menu_sd_askstop_no, &ui_menu_sd_askstop_yes }
...
#define UI_MENU_SD \
    { UI_MENU_ADDCONDBACK &ui_menu_sd_printfile, &ui_menu_sd_pause, &ui_menu_sd_continue, &ui_menu_sd_stop UI_MOUNT_CMD, &ui_menu_sd_delete }
...
#define UI_MENU_DEBUGGING \
    { UI_MENU_ADDCONDBACK &ui_menu_debug_echo, &ui_menu_debug_info, &ui_menu_debug_error, &ui_menu_debug_dryrun, &ui_menu_debug_endstop }
...
#define UI_MENU_ACCEL \
    { UI_MENU_ADDCONDBACK &ui_menu_accel_printx, &ui_menu_accel_printy, &ui_menu_accel_printz, &ui_menu_accel_travelx, &ui_menu_accel_travely, &ui_menu_accel_travelz, &ui_menu_accel_jerk, &ui_menu_accel_zjerk }
...
#define UI_MENU_FEEDRATE \
    { UI_MENU_ADDCONDBACK &ui_menu_feedrate_maxx, &ui_menu_feedrate_maxy, &ui_menu_feedrate_maxz, &ui_menu_feedrate_homex, &ui_menu_feedrate_homey, &ui_menu_feedrate_homez }
...
UI_MENU_CHANGEACTION_T(ui_menu_accel_jerk, UI_TEXT_JERK_ID, UI_ACTION_MAX_JERK)
#define UI_MENU_ACCEL \
    { UI_MENU_ADDCONDBACK &ui_menu_accel_printz, &ui_menu_accel_travelz, &ui_menu_accel_jerk }
...
#define UI_MENU_CEXTR \
    { UI_MENU_ADDCONDBACK UI_MENU_CONFEXTCOND &ui_menu_cext_steps, &ui_menu_cext_start_feedrate, &ui_menu_cext_max_feedrate, &ui_menu_cext_acceleration, &ui_menu_cext_watch_period, &ui_menu_ext_wait_units, &ui_menu_ext_wait_temp UI_MENU_ADVANCE UI_MENU_PIDCOND }
...
#define UI_MENU_BEDCONF \
    { UI_MENU_ADDCONDBACK UI_MENU_COATING_COND &ui_menu_cext_manager, &ui_menu_cext_pgain, &ui_menu_cext_igain, &ui_menu_cext_dgain, &ui_menu_cext_dmin, &ui_menu_cext_dmax, &ui_menu_cext_pgain_dt, &ui_menu_cext_pmax }
...
#define UI_MENU_CONFIGURATION \
    { UI_MENU_ADDCONDBACK &ui_menu_sub_info, LANGMENU_ENTRY &ui_menu_conf_extr UI_MENU_BEDCONF_COND, &ui_menu_general_baud UI_MENU_EEPROM_COND UI_MENU_DELTA_COND UI_MENU_SL_COND }
...
#define UI_MENU_PREHEAT_SUB \
    { &ui_menu_preheat_hdl UI_MENU_ADDCONDBACK_C UI_MENU_PREHEAT_BED UI_MENU_PREHEAT_EXT0 UI_MENU_PREHEAT_EXT1 UI_MENU_PREHEAT_EXT2 UI_MENU_PREHEAT_EXT3 UI_MENU_PREHEAT_EXT4 UI_MENU_PREHEAT_EXT5, &ui_menu_chf_sph_pla_a, &ui_menu_chf_sph_petg_a, &ui_menu_chf_sph_pva_a, &ui_menu_chf_sph_flex_a, &ui_menu_chf_sph_abs_a, &ui_menu_chf_sph_glass_a, &ui_menu_chf_sph_wood_a }
...
#define UI_MENU_SETUP \
    { UI_MENU_ADDCONDBACK &ui_debug UI_MENU_PREHEAT UI_TOOGLE_AUTOLEVEL_ENTRY UI_CALIB_PROBE_ENTRY UI_DISTORTION_ENTRY UI_CAL_ZHEIGHT_ENTRY, &ui_calex, &ui_menu_fan_ignoreM106 }
...
#define UI_MENU_MAIN \
    { UI_MENU_ADDCONDBACK &ui_menu_control, &ui_stop, &ui_pause, &ui_continue UI_CHANGE_FIL_ENT_PRINTING BABY_ENTRY_PRINTING, &ui_menu_quick_speedmultiply_printing, &ui_menu_quick_flowmultiply_printing UI_TEMP0_PRINTING UI_TEMP1_PRINTING UI_TEMP2_PRINTING UI_TEMP3_PRINTING UI_TEMP4_PRINTING UI_TEMP5_PRINTING UI_BED_TEMP_PRINTING UI_FANSPEED_PRINTING UI_FAN2SPEED_PRINTING, SD_PRINTFILE_ENTRY &ui_menu_settings }
// &ui_menu_move, &ui_menu_extrudercontrol,

UI_MENU(ui_menu_main, UI_MENU_MAIN, 7 + UI_MENU_BACKCNT + SD_PRINTFILE_ENTRY_CNT + UI_TEMP0_CNT + UI_TEMP1_CNT + UI_TEMP2_CNT + UI_TEMP3_CNT + UI_TEMP4_CNT + UI_TEMP5_CNT + BABY_CNT + HAVE_HEATED_BED + UI_MENU_FAN_CNT + UI_MENU_FAN2_CNT + UI_CHANGE_FIL_CNT)
