...
extern void cEEPROMWrite();
extern void cEEPROMInitUncached();
...
#undef EVENT_EEPROM_WRITE_SETTINGS
#undef EVENT_EEPROM_INIT_UNCACHED
...
#define EVENT_EEPROM_WRITE_SETTINGS cEEPROMWrite();
#define EVENT_EEPROM_INIT_UNCACHED cEEPROMInitUncached();
...
#define EPR_FELIX_SERVO0 EPR_CUSTOM_START
#define EPR_FELIX_SERVO1 EPR_CUSTOM_START + 2

static inline float felixServoPos0() {
#if EEPROM_MODE != 0
    return HAL::eprGetInt16(EPR_FELIX_SERVO0);
#else
    return FELIX_EXT0_SERVOS_POS;
#endif
}

static inline float felixServoPos1() {
#if EEPROM_MODE != 0
    return HAL::eprGetInt16(EPR_FELIX_SERVO1);
#else
    return FELIX_EXT1_SERVOS_POS;
#endif
}
